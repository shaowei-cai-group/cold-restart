...
OPTION( rephasep1,      400,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep2,      350,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep3,      100,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep4,      50,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep5,      40,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep6,      10,  1,1e3,0,0,1, "rephase prob") \
OPTION( rephasep7,      20,  1,1e2,0,0,1, "rephase prob") \
...
OPTION( reset_intv,        1000000,  0,1e6,0,0,1, "reset interval") \
